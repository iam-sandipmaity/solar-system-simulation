        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: 24 }}>
          ...
          {/* Rocket SVG */}
            <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
              {/* Body */}
              <path d="M22 4C22 4 31 12 31 24H13C13 12 22 4 22 4Z" fill="#c8842a" stroke="#f0a030" strokeWidth="1"/>
              {/* Nose cone highlight */}
              <path d="M22 4C22 4 27 10 28 18H22V4Z" fill="#f0d080" opacity="0.45"/>
              {/* Window */}
              <circle cx="22" cy="17" r="4" stroke="#facc15" strokeWidth="1.5"/>
              <circle cx="22" cy="17" r="2" fill="#1a0f05"/>
              {/* Left fin */}
              <path d="M13 24L6 34H14V24Z" fill="#7a4010" stroke="#c8842a" strokeWidth="0.8"/>
              {/* Right fin */}
              <path d="M31 24L38 34H30V24Z" fill="#7a4010" stroke="#c8842a" strokeWidth="0.8"/>
              {/* Bottom body */}
              <rect x="13" y="24" width="18" height="10" rx="1" fill="#9a5a18"/>
              {/* Exhaust flame */}
            ...
            <p style={{ color: '#9ca3af', fontSize: 14, flex: 1, margin: 0, lineHeight: 1.6 }}>
              Voyager 1 & 2, Pioneer 10 & 11, New Horizons, Parker Solar Probe, Juno, and Cassini —
              real NASA JPL Horizons paths drawn through the same solar system.
            </p>
            <Link
              href="/solar"
              style={{
